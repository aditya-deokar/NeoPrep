...
// export const GenerateChapterContentLayout1 = async (
//   courseName: string,
//   chapter: { ChapterName: string; About: string; }
// ) => {
//   try {
//     const CHAPTER_PROMPT = `Explain the concept in detail on Topic: ${courseName}, specific in Chapter: ${chapter.ChapterName}, cover all the chapter points like ${chapter.About} and add more. Ensure content is properly formatted, Format the response in a structured JSON format similar to the following example:
//     {
//   "chapterId": "CH008",
...
//     {
//       "questionId": "AQ008-3",
//       "questionText": "Explain the difference between ArrayList and LinkedList. Provide use-case",
//       "options": [],
...
//        {
//       "questionId": "AQ008-4",
//       "questionText": "When to use custom collections?",
//       "options": [],
//       "correctAnswerIndex": 0,
//       "bloomLevel": "Understanding"
//     }
  ...
  try {
    ...
    const { object } = await generateObject({
      ...
      "learningResources": [
        ...
        `,
      system:
        "You are a highly skilled AI assistant specializing in generating JSON objects that conform to a specified schema.  Your output must be valid JSON and should adhere strictly to the provided schema.  Do not add any additional information, explanations, or commentary unless explicitly requested. Focus on generating accurate and relevant data based on the given descriptions.",
    });
